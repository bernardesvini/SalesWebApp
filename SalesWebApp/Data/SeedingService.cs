...
namespace SalesWebApp.Data
{
    ...
    {
        private SalesWebAppContext _context; //*Mycomments injeção de dependência, ou seja sempre que iniciado, ele vai receber um context
        ...
        public void Seed() // *Mycomments metodo que sera usado para popular a base de dados
        {
            if (_context.Department.Any() || _context.Seller.Any() || _context.SalesRecord.Any()) // *Mycomments metodo any do linq, verifica se há qualquer dado nas tabelas
                return;
            ...
            _context.Department.AddRange(d1, d2, d3, d4); // *Mycomments Metodo AddRange, permite colocar varios objetos de uma vez na Base de Dados
            ...
            _context.SaveChanges();// *Mycomments confirma as alterações
        }
    }
}
